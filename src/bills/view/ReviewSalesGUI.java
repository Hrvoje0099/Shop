		...
		btnPrintTotal.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					document.add(new Paragraph("Ukupan broj računa: " + txtBillNumber.getText(), f1));
		...
		btnPrintTable.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Chunk chunkTitle = new Chunk("PREGLED PRODAJE POJEDINAČNO", f3);
					chunkTitle.setUnderline(0.1f, -2f);
			        ...
			        for(int i = 0; i < 1; i++) {
			        	...
			        	table1.addCell(new PdfPCell(new Phrase("Br. računa", f2)));
			        	...
			        	table1.addCell(new PdfPCell(new Phrase("Način plaćanja", f2)));
